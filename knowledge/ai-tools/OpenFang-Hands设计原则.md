...
> [!info] 概述
> OpenFang 是一个开源的 [[Agent操作系统]]（Rust 实现），7 天斩获 7.5k stars。其 **Hands 设计模式** 值得借鉴。
...
- [[github-trending]] SKILL.md (V3.0)
- [[github-watch]] SKILL.md
...
- [[Capability-Evolver]]
- [[xiaoclaw-memory-三层架构]]

---

#openfang #skill-design #agent
